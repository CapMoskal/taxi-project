import { Briefcase, Car, Clock, CreditCard, Headphones, Info, MapPin, Settings, ShieldCheck, Star, Wallet } from 'lucide-react'
...
function ProfileScreen() {
  ...
  return (
    <ScreenShell title="Профиль" onBack={() => navigate('order')}>
